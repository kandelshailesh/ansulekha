...
$('#datemodify').calendarsPicker({ calendar: $.calendars.instance('gregorian'),dateFormat: 'yyyy-mm-dd'});

$('.dates1').append(`<input  id='datemodify' class='ml-1 border-0 d-inline' value=${currentdate}>`);

$('#datemodify').calendarsPicker({ calendar: $.calendars.instance('gregorian'),dateFormat: 'yyyy-mm-dd'});
// $('#previousyear').calendarsPicker({ calendar: $.calendars.instance('gregorian'),dateFormat: 'yyyy-mm-dd'});
